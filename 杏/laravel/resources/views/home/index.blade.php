...
<html>
	...
	<nav class="fh5co-nav" role="navigation">
		...
		<div class="top-menu">
			<div class="container">
				<div class="row">
					<div class="col-xs-2">
						<div id="fh5co-logo"><a href="{{url('home/index')}}"><i class="icon-study"></i>Educ<span>.</span></a></div>
					</div>
					<div class="col-xs-10 text-right menu-1">
						<ul>
							<li class="active"><a href="{{url('home/index')}}">Home</a></li>
							<li><a href="{{url('home/courses')}}">Courses</a></li>
							<li><a href="{{url('home/teacher')}}">Teacher</a></li>
							...
							<li class="btn-cta"><a href="{{url('home/login')}}"><span>Login</span></a></li>
						...
						<div class="owl-carousel owl-carousel-fullwidth">
							<div class="item">
								<div class="testimony-slide active text-center">
									<div class="user" style="background-image: url({{asset('images/person1.jpg')}});"></div>
							...
							<div class="item">
								<div class="testimony-slide active text-center">
									<div class="user" style="background-image: url({{asset('images/person2.jpg')}});"></div>
							...
							<div class="item">
								<div class="testimony-slide active text-center">
									<div class="user" style="background-image: url({{asset('images/person3.jpg')}});"></div>
			...
			<div class="row">
				<div class="col-lg-4 col-md-4">
					<div class="fh5co-blog animate-box">
						<a href="#" class="blog-img-holder" style="background-image: url({{asset('images/project-1.jpg')}});"></a>
						<div class="blog-text">
				...
				<div class="col-lg-4 col-md-4">
					<div class="fh5co-blog animate-box">
						<a href="#" class="blog-img-holder" style="background-image: url({{asset('images/project-2.jpg')}});"></a>
						<div class="blog-text">
							<h3><a href="#">Healty Lifestyle &amp; Living</a></h3>
							<span class="posted_on">March. 15th</span>
							<span class="comment"><a href="">21<i class="icon-speech-bubble"></i></a></span>
				...
				<div class="col-lg-4 col-md-4">
					<div class="fh5co-blog animate-box">
						<a href="#" class="blog-img-holder" style="background-image: url({{asset('images/project-3.jpg')}});"></a>
						<div class="blog-text">
							<h3><a href="#">Healty Lifestyle &amp; Living</a></h3>
							<span class="posted_on">March. 15th</span>
							<span class="comment"><a href="">21<i class="icon-speech-bubble"></i></a></span>
	...
	<div id="fh5co-register" style="background-image: url({{asset('images/img_bg_2.jpg')}});">
		<div class="overlay"></div>
		<div class="row">
	...
	<div id="fh5co-gallery" class="fh5co-bg-section">
		...
		<div class="row">
			<div class="col-md-3 col-padded">
				<a href="#" class="gallery" style="background-image: url({{asset('images/project-5.jpg')}});"></a>
			</div>
			<div class="col-md-3 col-padded">
				<a href="#" class="gallery" style="background-image: url({{asset('images/project-2.jpg')}});"></a>
			</div>
			<div class="col-md-3 col-padded">
				<a href="#" class="gallery" style="background-image: url({{asset('images/project-3.jpg')}});"></a>
			</div>
			<div class="col-md-3 col-padded">
				<a href="#" class="gallery" style="background-image: url({{asset('images/project-4.jpg')}});"></a>
			</div>
		</div>
	</div>
